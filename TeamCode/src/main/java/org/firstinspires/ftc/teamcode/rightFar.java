...
public class rightFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (signal == 1) {  // left
            iRobot.forwardMode();
            iRobot.resetEncoder();
            iRobot.moveRobot(1100, 1100, 0.3); // move forward
            iRobot.resetEncoder();
            iRobot.moveRobot(-430, 430, 0.3); // turn left
            iRobot.resetEncoder();
        ...
        iRobot.forwardMode();
        iRobot.resetEncoder();
        iRobot.moveRobot(430, -430, 0.3); // turn right
        iRobot.resetEncoder();
        iRobot.moveRobot(4000, 4000, 0.3); // move forward
